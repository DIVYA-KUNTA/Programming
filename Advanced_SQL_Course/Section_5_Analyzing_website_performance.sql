...
-- MAGIC %md
-- MAGIC # Analyzing Top Website Pages & Entry Pages
...
-- MAGIC %md
-- MAGIC # Finding Top Website Pages
...
-- MAGIC %md
-- MAGIC # Calculating Bounce Rates
-- MAGIC
...
-- MAGIC %md
-- MAGIC # Analyzing Landing Page Tests
-- MAGIC
...
-- MAGIC %md
-- MAGIC # Landing Page Trend Analysis
-- MAGIC
...
-- MAGIC %md
-- MAGIC # Building Conversion Funnels
-- MAGIC
...
-- MAGIC %md
-- MAGIC # Analyzing Conversion Funnel Tests
